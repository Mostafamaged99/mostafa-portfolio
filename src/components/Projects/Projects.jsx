  ...
  return (
    <>
      ...
      <div className="app" onMouseMove={handleMouseMove}>
        ...
        <Navbar />
        <section className="projects main-bg-color py-5 p-0 m-0">
                  ...
                  <div className="swiper-slide text-center">
                    <div className="swiper-slide-text">
                      ...
                      >
                        ...
                        pricing details in Egyptian pounds, and ratings for some
                        items. electronics.
                      </p>
                      <p
                        data-aos="fade-left"
                      ...
                      >
                        ...
                        Authentication &amp; Authorization &amp; Online Payment
                        Support &amp; API Data Handling (GET, DELETE, PUT, POST)
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        ...
                        Corba, Sushi, Burek, Bistek, and Ribollita. It seems to
                        showcase a diverse range of popular dishes from
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        ...
                        real-time weather information. Users can enter a city or
                        location to receive current temperature updates, weather
                        conditions, and forecasts. The app also displays the
                        chance of rain at various times throughout the day and
                        keeps a recent cities list, which can be cleared as
                        needed. The interface is user-friendly and designed to
                        offer quick and accurate weather updates for any
                        specified location.
                      </p>
                      <p className="h4 fw-medium text-secondary  text-start lh-base">
                        <span className="h3 fw-bolder">
                ...
                <div>
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        <span className="h3 fw-bolder">Description: </span>The
                        Login System website appears to be a login system. Users
                        can enter their email address and password to sign in to
                        their account. The webpage displays error messages for
                        invalid email addresses and passwords that don't meet
                        the regex. There are options to create a new account and
                        a "LOGIN FAILED" message is displayed for invalid email
                        or password entries, prompting users to try again.
                      </p>
                      <p className="h4 fw-medium text-secondary  text-start lh-base">
                        <span className="h3 fw-bolder">
                          Features &amp; Tecnologies:{" "}
                        </span>
                        Html5 & Css3 & Javascript & Netlify & Regex & Protected
                        routes & Bootstrap (Framework) & Responsive Web Design &
                        deploy.
                      </p>
                      <button className="btn checkBtn w-25 mt-3 mb-5 fw-bold">
                        <Link
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        ...
                        "BOOKMARKER" for bookmarking your favorite websites. The
                        site seems to offer a service where users can submit the
                        name and URL of the website they want to bookmark. It
                        also looks like there are options to index websites,
                        view website names, visit the bookmarked sites, and
                        delete bookmarks. The site focuses on simplifying the
                        process of saving and organizing your favorite online
                        destinations for quick acces.
                      </p>
                      <p className="h4 fw-medium text-secondary  text-start lh-base">
                        <span className="h3 fw-bolder">
                          Features &amp; Tecnologies:{" "}
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        ...
                        designed to motivate, uplift, and encourage reflection.
                        Whether you're seeking wisdom on life, love, success, or
                        personal growth, you'll find a rich array of quotes from
                        notable figures and timeless sources. Dive in to
                        discover words that resonate, inspire change, and spark
                        contemplation. Join us in celebrating the power of words
                ...
                <div>
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        <span className="h3 fw-bolder">Description: </span>This
                        website belongs to a UI/UX designer and web developer
                        named Jerry Daniels. On the website, visitors can find
                        information about Jerry, his services, works, clients,
                        and team members. Visitors can also download his CV, see
                        a portfolio of his work, read testimonials from his
                        customers, and get in touch with him via phone or email.
                        The website is responsive and retina ready, meaning that
                        the design will adjust and look good on devices of
                        different sizes and display qualities.
                      </p>
                      <p className="h4 fw-medium text-secondary  text-start lh-base">
                        <span className="h3 fw-bolder">
                          Features &amp; Tecnologies:{" "}
                        </span>
                        HTML5, CSS & position & Flex box & Bootstrap & Transform
                  ...
                  <div className="swiper-slide  ">
                    <div className="swiper-slide-text">
                      ...
                      <p className="h4 fw-medium text-secondary  my-3 text-start lh-base">
                        ...
                        simplify meal planning and recipe management. It offers
                        a seamless experience for users to discover new recipes,
                        plan meals, and manage grocery lists efficiently.
                        Featuring an intuitive interface, Mealify helps users
                        save time and stay organized by providing customized
                        meal suggestions and easy access to recipe details.
                        Whether you’re a culinary enthusiast or someone looking
                        to streamline your meal prep, Mealify makes meal
                        planning a breeze.
                      </p>
                      <p className="h4 fw-medium text-secondary  text-start lh-base">
                        <span className="h3 fw-bolder">
