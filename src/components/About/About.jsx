  ...
  return (
    <div>
      ...
      <div className="custom-pointer" style={{ left: mouseX, top: mouseY }}>
        ...
        <span role="img" aria-label="pointer " className="text-react">.</span>
      </div>
      <Navbar />
      <section id="About" className="about py-5 d-flex align-items-center  ">
        <div className="container py-5">
          ...
          <div className="row">
            ...
            <div className="col-md-7 py-5 d-flex align-items-center" data-aos="fade-left" >
